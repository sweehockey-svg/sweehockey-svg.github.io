...
/* =========================================================
   ...
   Swedish team = nhlgamer_leagueTeams.country = 'SE' OR manually listed Swedish teamID (93 IDs). Team name is taken from nhlgamer_leagueTeams.teamName per league season, so same teamID can show different names in different leagues.
