...
`;
  ...
  function ensureHome(){
    ...
    home.querySelector('.seh-card-grid').insertAdjacentHTML('beforeend',`<button type="button" class="seh-card wide" id="seh-home-fa" style="text-align:left;font:inherit"><div><div class="ico">${icons.players}</div><strong>Free Agents</strong><span>Söker ditt lag spelare? Se vilka som är tillgängliga och hitta förstärkningar.</span></div></button>`);
