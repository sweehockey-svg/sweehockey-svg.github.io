(() => {
  ...
  const backgroundPrefix = "lab/match-image-generator/backgrounds/";
  ...
  function buildClassicSvg() {
    ...
    const classicLineupY = layout.lineupY + (isSquare ? 12 : 0);
    const lineup = lineupForTemplate(W,classicLineupY,own,ownVariant);
    const lineupGraphic = isSquare
      ? '<g transform="translate(' + (W/2) + ' ' + classicLineupY + ') scale(1.055) translate(' + (-W/2) + ' ' + (-classicLineupY) + ')">' + lineup + '</g>'
      : lineup;
    ...
    const panelY = isWide ? 678 : isStory ? 1042 : 700;
    const panelW = W - panelX * 2;
    const panelH = isWide ? 336 : isStory ? 790 : 308;
    const lineupTitleY = panelY + (isStory ? 42 : isWide ? 38 : 36);
    const panelFillOpacity = isSquare ? ".42" : ".30";
    const panelStrokeOpacity = isSquare ? ".14" : ".20";
    ...
    const vsY = layout.vsY + (isSquare ? -16 : 0);
    const metaY = layout.metaY + (isSquare ? -19 : 0);
    const streamWidth = isWide ? 520 : isStory ? 520 : 350;
    const streamHeight = isStory ? 54 : isWide ? 48 : 36;
    const streamY = metaY + (isStory ? 38 : isWide ? 24 : 22);
    ...
    return [
      ...
      '<ellipse cx="' + (W/2) + '" cy="' + vsY + '" rx="' + (isWide?118:84) + '" ry="' + (isWide?84:62) + '" fill="#2f8fff" opacity=".24" filter="url(#classic-blue-glow)"/>',
      '<circle cx="' + (W/2) + '" cy="' + vsY + '" r="' + (isWide?78:58) + '" fill="#06111c" fill-opacity=".44" stroke="#8fcaff" stroke-opacity=".16"/>',
      '<circle cx="' + (W/2) + '" cy="' + vsY + '" r="' + (isWide?64:48) + '" fill="none" stroke="#ffffff" stroke-opacity=".08"/>',
      '<text x="' + (W/2) + '" y="' + (vsY + vsSize*.30) + '" text-anchor="middle" fill="url(#classic-vs)" font-size="' + vsSize + '" font-weight="1000" font-style="italic" font-family="Arial Black,Arial,Helvetica,sans-serif" letter-spacing="-5" filter="url(#classic-title-shadow)">VS</text>',
      '<text x="' + (W/2) + '" y="' + metaY + '" text-anchor="middle" fill="#ffffff" font-size="' + metaSize + '" font-weight="1000" font-family="Arial,Helvetica,sans-serif" letter-spacing="' + (isWide?3:1) + '">' + date + ' · ' + time + '</text>',

      stream ? '<g><rect x="' + (W/2-streamWidth/2) + '" y="' + streamY + '" width="' + streamWidth + '" height="' + streamHeight + '" rx="' + (streamHeight/2) + '" fill="#06101b" fill-opacity=".82" stroke="#8fc8ff" stroke-opacity=".42"/><circle cx="' + (W/2-streamWidth/2+32) + '" cy="' + (streamY+streamHeight/2) + '" r="8" fill="#ff4d5f"/><circle cx="' + (W/2-streamWidth/2+32) + '" cy="' + (streamY+streamHeight/2) + '" r="15" fill="#ff4d5f" opacity=".15"/><text x="' + (W/2) + '" y="' + (streamY+streamHeight/2+6) + '" text-anchor="middle" fill="#ffffff" font-size="' + (isStory?20:isWide?18:14) + '" font-weight="900" font-family="Arial,Helvetica,sans-serif" letter-spacing="1.5">' + stream + '</text><path d="M' + (W/2+streamWidth/2-42) + ' ' + (streamY+streamHeight/2-7) + ' l8 7 -8 7" fill="none" stroke="#a9d5ff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></g>' : '',

      '<rect x="' + panelX + '" y="' + panelY + '" width="' + panelW + '" height="' + panelH + '" rx="' + (isWide?28:22) + '" fill="#06101b" fill-opacity="' + panelFillOpacity + '" stroke="#9ccfff" stroke-opacity="' + panelStrokeOpacity + '"/>',
  ...
  function buildStartingSixSvg() {
    ...
    return [
      ...
      isWide
        ...
        : isStory
          ? '<text x="' + (ctx.W-145) + '" y="' + (opponentLogoY-14) + '" text-anchor="middle" fill="#ffffff" fill-opacity=".45" font-size="11" font-weight="900" font-family="Arial,Helvetica,sans-serif" letter-spacing="2">MOT</text>' + svgLogo(ctx.opponent,ctx.W-opponentLogoSize-101,opponentLogoY,opponentLogoSize,.94) + '<text x="' + (ctx.W-145) + '" y="' + (opponentLogoY+opponentLogoSize+22) + '" text-anchor="middle" fill="#ffffff" font-size="17" font-weight="900" font-family="Arial,Helvetica,sans-serif">' + esc(cleanText(ctx.opponent.name,16)) + '</text>'
  ...
  function buildBroadcastSvg() {
    ...
    return [
      ...
      state.teamVisual === "logo" ? svgLogo(ctx.home,ctx.W*.21-homeLogo/2,logoY,homeLogo,.98) : teamHeroVisual(ctx.home,"home",ctx.W*.21-jerseySize/2,logoY,jerseySize),
      state.teamVisual === "logo" ? svgLogo(ctx.away,ctx.W*.79-homeLogo/2,logoY,homeLogo,.98) : teamHeroVisual(ctx.away,"away",ctx.W*.79-jerseySize/2,logoY,jerseySize),
      '<text x="' + (ctx.W*.21) + '" y="' + (logoY+(state.teamVisual === "logo" ? homeLogo : jerseySize)+30) + '" text-anchor="middle" fill="#fff" font-size="' + (isStory?25:19) + '" font-weight="900" font-family="Arial,Helvetica,sans-serif">' + esc(ctx.home.name) + '</text>',
