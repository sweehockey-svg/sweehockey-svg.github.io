...
function SEH_initHistory() {
  ...
  (() => {
    ...
    const APP_BUILD = "2026-08-29-v1245-statistics-dashboard";
...
function SEH_initPlayers() {
  ...
  (() => {
    ...
    const APP_BUILD = "2026-08-27-player-directory-v122";
    const PAGE_SIZE = 1000;
    const MAX_RETRIES = 2;
    ...
    async function replaceNationalTeamLatest(rows) {
      ...
      for (const historyRow of historyRows) {
        ...
        const teamName = clean(historyRow.team_current_name || historyRow.team_name_in_tournament);
    ...
    async function fetchDirectory() {
      const rows = await fetchPages("v_ehockey_swedish_player_directory_central_v1", {
        select: [
    ...
    function playerCard(player) {
      ...
      link.innerHTML = `
        ...
        <div class="players-card__content-v122">
...
(() => {
  ...
  const routeBodyClasses = {"home": "directory-page portal-page", "news": "directory-page portal-page", "players": "directory-page portal-page", "history": "directory-page", "player": "history-body", "team": "history-body", "teamTournament": "history-body", "tournament": "history-body tournament-overview-body", "shop": "directory-page shop-page", "support": "directory-page portal-page support-page", "season": "directory-page portal-page"};
  ...
  async function render() {
    ...
    if (route.key !== "support") {
      const footerInner = view.querySelector(".directory-footer > div");
      if (footerInner && !footerInner.querySelector(".directory-footer__support")) {
