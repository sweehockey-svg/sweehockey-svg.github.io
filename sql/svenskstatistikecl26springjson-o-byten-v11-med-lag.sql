...
playoff_team_match_rows AS (
  SELECT
    ...
    CASE
      ...
      WHEN m.leagueID IN (509,510,511) AND m.matchDate >= '2026-06-16' THEN 'Semifinal'
      WHEN m.leagueID IN (509,510,511) AND m.matchDate >= '2026-06-09' THEN 'Kvartsfinal'
      WHEN m.leagueID = 510 AND m.matchDate >= '2026-06-02' THEN 'Runda 2'
      WHEN m.leagueID IN (509,511) AND m.matchDate >= '2026-05-31' THEN 'Runda 2'
