  ...
  function renderTeamDetail(team) {
    ...
    return `<div class="ecl27v2-detail">
      ...
      <section class="ecl27v2-detail-panel ecl27v2-detail-roster-featured">
        <div class="ecl27v2-detail-panel-head"><div><p class="directory-kicker">JUST NU</p><h3>Känd trupp</h3></div><div class="ecl27v2-roster-status"><b class="is-${status.tone}">${esc(status.label)}</b><span>${team.playersNow.length} spelare</span></div></div>
