/*
  ...
  Lila skeppet behålls i vyn tills vi har tydligare besked om laget.
*/
(function () {
  "use strict";
    ...
    try {
      ...
      for (const node of section.querySelectorAll(".ecl27-candidate-team small")) {
        node.textContent = String(node.textContent || "")
          .replace("35 bekräftade lag/projekten", "34 bekräftade lag/projekten")
          .replace("33 bekräftade lag/projekten", "34 bekräftade lag/projekten");
      }
    } finally {
      applying = false;
    }
