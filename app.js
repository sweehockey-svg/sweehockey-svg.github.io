...
(() => {
  ...
  templates.home = templates.home.replace('<div class="portal-support-note home-stage__support"', '<div class="portal-actions" style="margin:20px 0;flex-wrap:wrap"><a class="portal-button portal-button--primary" href="/android.html">Ladda ner Android-appen</a></div><div class="portal-support-note home-stage__support"');
  templates.ecl = `
