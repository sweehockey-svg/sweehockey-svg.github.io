...
function SEH_initHistory() {
  ...
  (() => {
    ...
    const APP_BUILD = "2026-09-11-v13013-historical-team-rp";
    ...
    function calculateTeamRp() {
      ...
      for (const team of state.teams) {
        ...
        team.stats.teamRp = Math.round(teamRpClamp(adjustedRp, 0, 100));
    ...
    function createTeamCard(team, index) {
      ...
      if (teamRpNode) {
        teamRpNode.textContent = formatNumber(team.stats.teamRp);
      }
      if (teamRpRankNode) {
        teamRpRankNode.textContent = team.stats.teamRpGames > 0
          ? `#${team.stats.teamRpRank} av ${team.stats.teamRpScopeTeamCount} · ${team.stats.teamRpGames} GP historik`
          : "Nytt lag · 0 GP";
      }
