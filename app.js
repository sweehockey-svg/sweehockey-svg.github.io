...
(() => {
  ...
  const APP_BUILD = "2026-09-12-v13023-scl27-fantasy";
  ...
  templates.fantasy = window.SEH_FANTASY_TEMPLATE || `
    <main class="directory-shell fantasy-shell">
      <section class="notice notice-warning"><h2>SCL 27 Fantasy</h2><p>Fantasy-modulen kunde inte laddas. Ladda om sidan.</p></section>
    </main>
  `;
...
Free Agent-annonsen ligger kvar, men Discord-kontot måste kopplas och godkännas igen för att spelaren ska kunna hantera den själv.`))return;
  ...
  const routeControllers = {
    ...
    fantasy: window.SEH_initFantasy,
  ...
  function parseRoute() {
    ...
    if (parts[0] === "fantasy" && parts.length === 1) {
      return {
        ...route,
        key: "fantasy",
        label: "Fantasy",
  ...
  function titleFor(route) {
    ...
    const titles = {
      ...
      fantasy: "SCL 27 Fantasy – Svensk eHockey",
